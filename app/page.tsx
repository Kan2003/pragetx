      ...
      >
        ...
        >
          <Image
            ...
            width={150}
            height={40}
            className="cursor-pointer transition-all duration-500 transform w-[100px] sm:w-[120px] md:w-[150px] h-auto"
          />
        </button>

        <div className="word-break mt-4 sm:mt-6 md:mt-8 w-full px-4 sm:px-6 md:max-w-[800px]">
          <h1
            className={`mt-4 text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold uppercase italiana-regular ${isDark ? "text-gray-300" : "text-gray-800"}`}
          >
